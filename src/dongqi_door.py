...
class MinariRenderer:
	...
	def render(self, observations, timeouts):
		for step in range(0, observations.shape[0], 5):
			...
			imageio.imsave("./debug/door/test_%3.3d.png" % step, img)

		print("saved img to ./debug/door/")


if __name__ == "__main__":
	env, dataset = load_minari("door-expert-v1") # e.g. hammer-human-v1, door-human-v1
	observations = dataset["observations"][:1000]
	timeouts = dataset["timeouts"][:1000]
